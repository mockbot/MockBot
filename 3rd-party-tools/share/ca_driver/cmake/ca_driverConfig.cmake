...
if("FALSE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/ros/prog/catkin_ws/src/create_autonomy/ca_driver)
  set(ca_driver_DEVEL_PREFIX /home/ros/prog/catkin_ws/devel)
  ...
  set(ca_driver_INSTALL_PREFIX /opt/ros/prog/MockBot/3rd-party-tools)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/prog/MockBot/3rd-party-tools/${idir}'.  Ask the maintainer 'Jacob Perron <jperron@sfu.ca>' to fix it.")
    endif()
