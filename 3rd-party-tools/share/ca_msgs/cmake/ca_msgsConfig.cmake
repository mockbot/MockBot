...
if("FALSE" STREQUAL "TRUE")
  set(ca_msgs_SOURCE_PREFIX /home/ros/prog/catkin_ws/src/create_autonomy/ca_msgs)
  set(ca_msgs_DEVEL_PREFIX /home/ros/prog/catkin_ws/devel)
  set(ca_msgs_INSTALL_PREFIX "")
  set(ca_msgs_PREFIX ${ca_msgs_DEVEL_PREFIX})
else()
  set(ca_msgs_SOURCE_PREFIX "")
  set(ca_msgs_DEVEL_PREFIX "")
  set(ca_msgs_INSTALL_PREFIX /opt/ros/prog/MockBot/3rd-party-tools)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/prog/MockBot/3rd-party-tools/${idir}'.  Ask the maintainer 'Jacob Perron <jperron@sfu.ca>' to fix it.")
    endif()
