#ifndef _ROS_smart_battery_msgs_SmartBatteryStatus_h
#define _ROS_smart_battery_msgs_SmartBatteryStatus_h
...
namespace smart_battery_msgs
{
  ...
  class SmartBatteryStatus : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "smart_battery_msgs/SmartBatteryStatus"; };
